...
class MainActivity : AppCompatActivity(), TrackAdapter.OnItemClickListener {
    ...
    private fun playTrack(position: Int) {
        if (currentTrackIndex != position) {
            ...
            //trackAdapter.setCurrentTrackPosition(currentTrackIndex)
...
//            isPlaying = true
//            trackAdapter.setCurrentTrackIndex(currentTrackIndex)
//            trackAdapter.setPlayingStatus(isPlaying)
//            updatePlayButton()
//
//            handler.removeCallbacksAndMessages(null) // Удаляем предыдущие колбэки
//            runnable = object : Runnable {
//                override fun run() {
//                    val currentPosition = mediaPlayer.currentPosition
...
//    override fun onDestroy() {
//        mediaPlayer.release()
//        handler.removeCallbacksAndMessages(null) // Удаляем все колбэки и сообщения из очереди
//        super.onDestroy()
//    }
//}
//
